#ifndef CUTTERMONTHLYRPT_H
#define CUTTERMONTHLYRPT_H

#include <QObject>

class CutterMonthlyRpt : public QObject
{
    Q_OBJECT
    ...
    Q_PROPERTY(QString s009 READ getS009 WRITE setS009)

public:
    explicit CutterMonthlyRpt(QObject *parent = 0);
    QString toString();
